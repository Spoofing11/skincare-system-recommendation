            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li
                            class="sidebar-item <?php echo ($this->uri->segment(1) == 'home' || $this->uri->segment(1) == 'admin') ? 'selected' : ''; ?>">
                        ...
                        <li
                            class="sidebar-item <?php echo ($this->uri->segment(1) == 'skincare') ? 'selected' : ''; ?>">
                        ...
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                                    ...
                                    <img src="<?= base_url() ?>/assets/images/profile/user-2.png" alt="" width="35"
