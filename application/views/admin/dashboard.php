<div class="row">
    <div class="d-flex align-items-strech col-lg-8">
        <div class="card w-100">
            <div class="card-body">
                <img src="<?= base_url() ?>assets/images/welcome_illustrator.jpg" class="img-fluid"
    ...
    <div class="d-flex align-items-strech col-lg-4">
        <div class="card w-100">
            <div class="card-body text-center">
                <img src="<?= base_url() ?>assets/images/skincare_illustrator.jpg" class="img-fluid d-block mx-auto"
                    alt="Responsive image" />
